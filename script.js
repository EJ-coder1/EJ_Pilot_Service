...
/* ===================== RANK SELECTS ===================== */
/*
  MLBB rank badge SVGs — each emblem uses the correct color identity from the
  official Mobile Legends rank system. Crown/shield shapes match official imagery.
  Used for identification only. Mobile Legends: Bang Bang and rank emblems are
  trademarks of Moonton. EJ Pilot Service is not affiliated with Moonton.
*/
function rankBadgeSVG(name) {
  // Each badge: correct colors + crown/shield shape matching MLBB official rank emblems.
  // Grandmaster = silver-blue beast head shield
  // Epic = teal-green rhinoceros beast head shield
  // Legend = gold lion head shield
  // Mythic+ = gold ornate crown/dragon helmet shape (shared crown base, color differs)
  const badges = {

    // GRANDMASTER — Silver-blue shield with beast head (wolf/lion), cool silver tones
    "Grandmaster": `<svg class="rank-badge rank-badge-gm" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="gm1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#c8daf5"/><stop offset="1" stop-color="#5a7ab8"/></linearGradient><linearGradient id="gm2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#e8f0ff"/><stop offset="1" stop-color="#8aadda"/></linearGradient></defs><!-- Outer shield --><path d="M18 2 L31 7 L31 18 C31 26 25 32 18 34 C11 32 5 26 5 18 L5 7 Z" fill="url(#gm1)" stroke="#3a5a90" stroke-width="1.2" stroke-linejoin="round"/><!-- Inner face plate --><ellipse cx="18" cy="17" rx="9" ry="9.5" fill="url(#gm2)"/><!-- Beast ears / horns -->  <path d="M11 11 L8 6 L13 9 Z" fill="#5a7ab8"/><path d="M25 11 L28 6 L23 9 Z" fill="#5a7ab8"/><!-- Brow ridge --><path d="M11 14 Q14 11 18 11 Q22 11 25 14" fill="none" stroke="#2a4070" stroke-width="1.4" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="16" rx="2" ry="1.8" fill="#1a3060"/><ellipse cx="21.5" cy="16" rx="2" ry="1.8" fill="#1a3060"/><!-- Muzzle --><path d="M14 21 Q18 24 22 21" fill="none" stroke="#2a4070" stroke-width="1.2" stroke-linecap="round"/><!-- Chin detail --><path d="M16 24 Q18 26 20 24" fill="none" stroke="#3a5a90" stroke-width="1" stroke-linecap="round"/><!-- Center gem --><circle cx="18" cy="11" r="1.5" fill="#a0c0f0" stroke="#3a5a90" stroke-width="0.5"/></svg>`,

    // EPIC — Teal-green rhinoceros beast head, pointed horns, vivid green tones
    "Epic": `<svg class="rank-badge rank-badge-ep" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="ep1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#40d8b8"/><stop offset="1" stop-color="#0a7858"/></linearGradient><linearGradient id="ep2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#90eeda"/><stop offset="1" stop-color="#28a880"/></linearGradient></defs><!-- Outer shield --><path d="M18 2 L31 7.5 L31 18 C31 26 25 32 18 34 C11 32 5 26 5 18 L5 7.5 Z" fill="url(#ep1)" stroke="#086848" stroke-width="1.2" stroke-linejoin="round"/><!-- Inner face plate --><ellipse cx="18" cy="17.5" rx="9" ry="9.5" fill="url(#ep2)"/><!-- Rhino horns (two) --><path d="M15 10 L13.5 4 L16.5 9 Z" fill="#0a7858"/><path d="M21 10 L22.5 4 L19.5 9 Z" fill="#0a7858"/><!-- Brow ridge --><path d="M11 14 Q14.5 10.5 18 10.5 Q21.5 10.5 25 14" fill="none" stroke="#065040" stroke-width="1.5" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="16.5" rx="2" ry="1.8" fill="#043828"/><ellipse cx="21.5" cy="16.5" rx="2" ry="1.8" fill="#043828"/><!-- Nose plate --><path d="M14.5 21 Q18 23.5 21.5 21" fill="none" stroke="#065040" stroke-width="1.3" stroke-linecap="round"/><!-- Chin --><path d="M16 24 Q18 26 20 24" fill="none" stroke="#0a7858" stroke-width="1" stroke-linecap="round"/><!-- Gem --><circle cx="18" cy="11" r="1.5" fill="#c0fff0" stroke="#0a7858" stroke-width="0.5"/></svg>`,

    // LEGEND — Gold lion head shield. Warm deep gold, lion mane details
    "Legend": `<svg class="rank-badge rank-badge-lg" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="lg1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#ffd060"/><stop offset="1" stop-color="#b06010"/></linearGradient><linearGradient id="lg2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#ffe898"/><stop offset="1" stop-color="#d88820"/></linearGradient></defs><!-- Outer shield --><path d="M18 2 L32 7.5 L32 18 C32 27 25.5 33 18 35 C10.5 33 4 27 4 18 L4 7.5 Z" fill="url(#lg1)" stroke="#906010" stroke-width="1.2" stroke-linejoin="round"/><!-- Mane spikes around --><path d="M9 10 L6 5 L11 9 Z M27 10 L30 5 L25 9 Z M8 16 L3 14 L8 17 Z M28 16 L33 14 L28 17 Z M10 23 L6 26 L11 22 Z M26 23 L30 26 L25 22 Z" fill="#e0900a"/><!-- Inner lion face --><ellipse cx="18" cy="18" rx="9.5" ry="10" fill="url(#lg2)"/><!-- Brow --><path d="M11 15 Q14.5 11 18 11 Q21.5 11 25 15" fill="none" stroke="#7a4008" stroke-width="1.6" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="17" rx="2.2" ry="1.9" fill="#5a3008"/><ellipse cx="21.5" cy="17" rx="2.2" ry="1.9" fill="#5a3008"/><!-- Nose bridge --><path d="M17 20 L18 21.5 L19 20" fill="none" stroke="#7a4008" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><!-- Mouth/muzzle --><path d="M14 23 Q18 26.5 22 23" fill="none" stroke="#7a4008" stroke-width="1.4" stroke-linecap="round"/><!-- Crown gem top --><polygon points="18,3.5 19.2,6.5 18,5.8 16.8,6.5" fill="#fffbe0" stroke="#c07010" stroke-width="0.4"/></svg>`,

    // MYTHIC — Gold-purple ornate crown/dragon helmet. Purple-to-gold gradient, crown spires
    "Mythic": `<svg class="rank-badge rank-badge-my" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="my1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#d0a0ff"/><stop offset=".5" stop-color="#8040d0"/><stop offset="1" stop-color="#f0b840"/></linearGradient><linearGradient id="my2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#e8c8ff"/><stop offset="1" stop-color="#a060e0"/></linearGradient></defs><!-- Outer crown shield --><path d="M18 2 L32 8 L32 20 C32 28.5 26 34.5 18 36 C10 34.5 4 28.5 4 20 L4 8 Z" fill="url(#my1)" stroke="#6030a8" stroke-width="1.2" stroke-linejoin="round"/><!-- Crown spires top --><path d="M18 2 L16 7 M18 2 L20 7 M10 6 L9 2 L12 6 M26 6 L27 2 L24 6" stroke="#f0b840" stroke-width="1.8" stroke-linecap="round"/><!-- Gold orbs on spires --><circle cx="18" cy="2.5" r="1.5" fill="#ffd060"/><circle cx="9.5" cy="2.5" r="1.2" fill="#ffd060"/><circle cx="26.5" cy="2.5" r="1.2" fill="#ffd060"/><!-- Inner helmet face --><path d="M10 14 C10 9.5 13.5 7 18 7 C22.5 7 26 9.5 26 14 C26 18.5 23 22 20 24 L20 28 L18 30 L16 28 L16 24 C13 22 10 18.5 10 14Z" fill="url(#my2)"/><!-- Brow --><path d="M11.5 14 Q14.5 10.5 18 10.5 Q21.5 10.5 24.5 14" fill="none" stroke="#502090" stroke-width="1.4" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="16" rx="2" ry="1.8" fill="#301060"/><ellipse cx="21.5" cy="16" rx="2" ry="1.8" fill="#301060"/><!-- Mouth slot --><path d="M15 22 Q18 24.5 21 22" fill="none" stroke="#502090" stroke-width="1.2" stroke-linecap="round"/><!-- Center gem --><circle cx="18" cy="12" r="1.8" fill="#ffd060" stroke="#7030b0" stroke-width="0.6"/></svg>`,

    // MYTHICAL HONOR — Teal-gold crown helmet. Slightly shinier than Mythic, blue-cyan accent
    "Mythical Honor": `<svg class="rank-badge rank-badge-mh" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="mh1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#80e8ff"/><stop offset=".5" stop-color="#2090c0"/><stop offset="1" stop-color="#f0c840"/></linearGradient><linearGradient id="mh2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#c0f8ff"/><stop offset="1" stop-color="#40b8e0"/></linearGradient></defs><!-- Outer crown shield --><path d="M18 2 L32 8 L32 20 C32 28.5 26 34.5 18 36 C10 34.5 4 28.5 4 20 L4 8 Z" fill="url(#mh1)" stroke="#1070a0" stroke-width="1.2" stroke-linejoin="round"/><!-- Crown spires --><path d="M18 2 L16 7 M18 2 L20 7 M10 6 L9 2 L12 6 M26 6 L27 2 L24 6" stroke="#f0c840" stroke-width="1.8" stroke-linecap="round"/><!-- Gold orbs --><circle cx="18" cy="2.5" r="1.5" fill="#ffd860"/><circle cx="9.5" cy="2.5" r="1.2" fill="#ffd860"/><circle cx="26.5" cy="2.5" r="1.2" fill="#ffd860"/><!-- Inner face --><path d="M10 14 C10 9.5 13.5 7 18 7 C22.5 7 26 9.5 26 14 C26 18.5 23 22 20 24 L20 28 L18 30 L16 28 L16 24 C13 22 10 18.5 10 14Z" fill="url(#mh2)"/><!-- Brow --><path d="M11.5 14 Q14.5 10.5 18 10.5 Q21.5 10.5 24.5 14" fill="none" stroke="#106080" stroke-width="1.4" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="16" rx="2" ry="1.8" fill="#084060"/><ellipse cx="21.5" cy="16" rx="2" ry="1.8" fill="#084060"/><!-- Mouth --><path d="M15 22 Q18 24.5 21 22" fill="none" stroke="#106080" stroke-width="1.2" stroke-linecap="round"/><!-- Gem --><circle cx="18" cy="12" r="1.8" fill="#ffd860" stroke="#1080b0" stroke-width="0.6"/></svg>`,

    // MYTHICAL GLORY — Deep gold crown. Richest gold of the set, more ornate edges
    "Mythical Glory": `<svg class="rank-badge rank-badge-mgl" viewBox="0 0 36 36" width="26" height="26" aria-hidden="true"><defs><linearGradient id="mgl1" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#ffe090"/><stop offset=".4" stop-color="#e09020"/><stop offset="1" stop-color="#a85808"/></linearGradient><linearGradient id="mgl2" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#fff0b0"/><stop offset="1" stop-color="#e0a030"/></linearGradient></defs><!-- Outer crown shield --><path d="M18 1.5 L33 8 L33 20 C33 29 26.5 35.5 18 37 C9.5 35.5 3 29 3 20 L3 8 Z" fill="url(#mgl1)" stroke="#a06008" stroke-width="1.3" stroke-linejoin="round"/><!-- Extra ornate side wings --><path d="M5 12 L2 9 L5 14 Z M31 12 L34 9 L31 14 Z" fill="#e09020"/><!-- Crown spires (taller) --><path d="M18 1.5 L15.5 7.5 M18 1.5 L20.5 7.5 M10 6 L8.5 1 L12 5.5 M26 6 L27.5 1 L24 5.5" stroke="#ffe090" stroke-width="2" stroke-linecap="round"/><!-- Gold orbs --><circle cx="18" cy="2" r="1.7" fill="#fff4c0" stroke="#c07010" stroke-width="0.6"/><circle cx="9" cy="1.5" r="1.3" fill="#ffd060"/><circle cx="27" cy="1.5" r="1.3" fill="#ffd060"/><!-- Inner face plate --><path d="M10 14 C10 9 13.5 6.5 18 6.5 C22.5 6.5 26 9 26 14 C26 18.5 23 22.5 20 24.5 L20 28.5 L18 31 L16 28.5 L16 24.5 C13 22.5 10 18.5 10 14Z" fill="url(#mgl2)"/><!-- Brow detail --><path d="M11 14 Q14.5 10 18 10 Q21.5 10 25 14" fill="none" stroke="#805008" stroke-width="1.5" stroke-linecap="round"/><!-- Eyes --><ellipse cx="14.5" cy="16" rx="2.1" ry="1.9" fill="#504008"/><ellipse cx="21.5" cy="16" rx="2.1" ry="1.9" fill="#504008"/><!-- Mouth --><path d="M15 22.5 Q18 25 21 22.5" fill="none" stroke="#805008" stroke-width="1.3" stroke-linecap="round"/><!-- Center gem --><circle cx="18" cy="11" r="2" fill="#fff8d0" stroke="#a06008" stroke-width="0.7"/></svg>`,

    // MYTHICAL IMMORTAL — Radiant gold, glowing aura. The highest rank — Immortal glow effect
    "Mythical Immortal": `<svg class="rank-badge rank-badge-immortal" viewBox="0 0 40 40" width="28" height="28" aria-hidden="true"><defs><radialGradient id="miAura" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#fff5a0" stop-opacity="0.9"/><stop offset="60%" stop-color="#ffd040" stop-opacity="0.4"/><stop offset="100%" stop-color="#ffa000" stop-opacity="0"/></radialGradient><linearGradient id="miShield" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#fff0a0"/><stop offset=".35" stop-color="#ffca20"/><stop offset=".7" stop-color="#e08808"/><stop offset="1" stop-color="#c06000"/></linearGradient><linearGradient id="miFace" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#fff8c8"/><stop offset="1" stop-color="#f0c040"/></linearGradient><filter id="miGlowF"><feGaussianBlur stdDeviation="1.8" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><!-- Outer radiant aura --><circle cx="20" cy="20" r="19.5" fill="url(#miAura)"/><!-- Animated pulse ring (CSS will animate) --><circle cx="20" cy="20" r="17" fill="none" stroke="#ffd040" stroke-width="1" stroke-dasharray="4 3" opacity="0.6" class="immortal-ring"/><!-- Outer crown shield with glow filter --><path d="M20 2 L36 9 L36 22 C36 31.5 29 38 20 40 C11 38 4 31.5 4 22 L4 9 Z" fill="url(#miShield)" stroke="#c07008" stroke-width="1.4" stroke-linejoin="round" filter="url(#miGlowF)"/><!-- Extra blade-like side wings --><path d="M5 13 L1 9 L5.5 15 Z M35 13 L39 9 L34.5 15 Z" fill="#ffca20"/><!-- Crown spires (tallest — Immortal) --><path d="M20 2 L17 8.5 M20 2 L23 8.5 M11 7 L9 2 L13 6.5 M29 7 L31 2 L27 6.5 M6.5 11 L4 8 L7.5 12 Z M33.5 11 L36 8 L32.5 12 Z" stroke="#fff4b0" stroke-width="2.2" stroke-linecap="round"/><!-- Bright orbs on spires --><circle cx="20" cy="2.5" r="2" fill="white" stroke="#f0a000" stroke-width="0.6"/><circle cx="10" cy="2.5" r="1.5" fill="#fffce0" stroke="#e09000" stroke-width="0.4"/><circle cx="30" cy="2.5" r="1.5" fill="#fffce0" stroke="#e09000" stroke-width="0.4"/><!-- Inner face plate --><path d="M11 15 C11 9.5 14.5 7 20 7 C25.5 7 29 9.5 29 15 C29 20.5 25.5 25 22 27 L22 31.5 L20 34 L18 31.5 L18 27 C14.5 25 11 20.5 11 15Z" fill="url(#miFace)"/><!-- Brow ridge --><path d="M12.5 15 Q16 10.5 20 10.5 Q24 10.5 27.5 15" fill="none" stroke="#a06008" stroke-width="1.6" stroke-linecap="round"/><!-- Eyes —glowing gold dots --><ellipse cx="16" cy="17.5" rx="2.3" ry="2" fill="#806008"/><ellipse cx="24" cy="17.5" rx="2.3" ry="2" fill="#806008"/><circle cx="16" cy="17.2" r="0.9" fill="#fffce0"/><circle cx="24" cy="17.2" r="0.9" fill="#fffce0"/><!-- Mouth/chin detail --><path d="M16 24 Q20 27 24 24" fill="none" stroke="#a06008" stroke-width="1.4" stroke-linecap="round"/><!-- Center diamond gem --><polygon points="20,10 21.4,12 20,14 18.6,12" fill="white" stroke="#d09010" stroke-width="0.5"/><!-- Sparkle rays around Immortal badge --><path d="M20 3 L20 1 M34 8 L36 6 M6 8 L4 6 M37 20 L39 20 M3 20 L1 20 M34 32 L36 34 M6 32 L4 34" stroke="#ffd040" stroke-width="1.2" stroke-linecap="round" opacity="0.8"/></svg>`
  };
