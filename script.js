...
function updateSummary() {
  ...
  $("#summaryMMR").textContent     = mmrServer === "global" ? "Global" : mmrServer === "none" ? "Not specified" : "Philippines";
...
function updateFinalReview() {
  ...
  $("#reviewMMR")?.textContent   !== undefined && ($("#reviewMMR").textContent   = mmrServer === "global" ? "Global" : mmrServer === "none" ? "Not specified" : "Philippines");
...
function createOrderMessage() {
  ...
  const heroLabel  = effectiveHero
    ...
    : "General — any hero";
  const mmrLabel   = mmrServer === "global" ? "Global" : mmrServer === "none" ? "Not specified" : "Philippines";
