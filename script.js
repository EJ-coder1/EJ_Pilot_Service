...
/* ===================== CONFIGURATION ===================== */
const SITE = {
  messengerUsername: "https://www.facebook.com/profile.php?id=61592788734201", // Replace with your Facebook username
...
function createOrderMessage() {
  ...
  const url = `https://m.me/${encodeURIComponent(SITE.messengerUsername)}?text=${encodeURIComponent(message)}`;
